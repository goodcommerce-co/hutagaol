<!DOCTYPE html>
<html data-wf-page="6943b6d0b4b15149a8ae8550" data-wf-site="6943b6cfb4b15149a8ae84e5" lang="{{ $page->language ?? 'en' }}">
...
<head>
    ...
    @viteRefresh()
    <link rel="stylesheet" href="{{ vite('source/_assets/css/vendor.css') }}">
                    ...
                    <div class="wrap-column-footer">
                        ...
                        <div class="link-list-footer">
                            ...
                            <div class="w-layout-hflex flex-block-2">
                                ...
                                <a href="https://www.linkedin.com/in/stephan-hutagaol-sh-mkn-msi-cmed-89599b2b"
